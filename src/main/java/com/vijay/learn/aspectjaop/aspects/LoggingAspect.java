...
package com.vijay.learn.aspectjaop.aspects;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.vijay.learn.aspectjaop.BusinessLogic.getBusinessLogic(..))")
    ...
    @After("execution(* com.vijay.learn.aspectjaop.BusinessLogic.getBusinessLogic(..))")
    ...
    @AfterReturning("execution(* com.vijay.learn.aspectjaop.BusinessLogic.getBusinessLogic(..))")
    ...
    @AfterThrowing("execution(* com.vijay.learn.aspectjaop.BusinessLogic.getBusinessLogic(..))")
    ...
    @Around("execution(* com.vijay.learn.aspectjaop.BusinessLogic.getBusinessLogic(..))")
